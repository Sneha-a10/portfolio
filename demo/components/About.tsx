        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-slate-600 leading-relaxed">
              I am a Computer Science Engineer with a passion for solving complex problems through clean, efficient code. My journey began with C++ and algorithms, eventually evolving into full-stack web development.
            </p>
            <p className="text-slate-600 leading-relaxed">
            ...
            <div className="pt-4">
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="p-4 bg-slate-50 rounded-lg border border-slate-100">
                        <span className="block text-3xl font-bold text-slate-900 mb-1">20+</span>
